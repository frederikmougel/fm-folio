<template>
    <div class="text-center">
        <span>Firebase</span>
        <svg :width="size" :height="size" viewBox="0 0 256 351" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
            <defs>
